...
public class MetasNutricional {
    ...
    public String toString() {
        return "BarraNutricional{" + "id=" + id + ", calorias=" + calorias + ", proteinas=" + proteinas + ", carbohidratos=" + carbohidratos + ", vit_a=" + vit_a + ", vit_c=" + vit_c + ", vit_k=" + vit_k + ", fibra=" + fibra + ", calcio=" + calcio + '}';
    }
